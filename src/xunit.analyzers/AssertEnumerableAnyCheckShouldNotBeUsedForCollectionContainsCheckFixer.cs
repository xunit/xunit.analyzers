...
namespace Xunit.Analyzers
{
    ...
    public class AssertEnumerableAnyCheckShouldNotBeUsedForCollectionContainsCheckFixer : CodeFixProvider
    {
        ...
        public sealed override ImmutableArray<string> FixableDiagnosticIds { get; } = ImmutableArray.Create(Descriptors.X2012_AssertEnumerableAnyCheckShouldNotBeUsedForCollectionContainsCheck.Id);
