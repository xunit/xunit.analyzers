...
namespace Xunit.Analyzers
{
    ...
    public class AssertCollectionContainsShouldNotUseBoolCheckFixer : CodeFixProvider
    {
        ...
        public sealed override ImmutableArray<string> FixableDiagnosticIds { get; } = ImmutableArray.Create(Descriptors.X2017_AssertCollectionContainsShouldNotUseBoolCheck.Id);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            var assertMethodName = context.Diagnostics.First().Properties[AssertCollectionContainsShouldNotUseBoolCheck.MethodName];
            ...
            editor.ReplaceNode(invocation,
                invocation
                    .WithArgumentList(SyntaxFactory.ArgumentList(
                        SyntaxFactory.SeparatedList(invocationExpressionSyntax.ArgumentList.Arguments.Insert(1, SyntaxFactory.Argument(anyTarget)))))
