...
namespace Xunit.Analyzers
{
    ...
    public class AssertNullShouldNotBeCalledOnValueTypesFixer : CodeFixProvider
    {
        ...
        public sealed override ImmutableArray<string> FixableDiagnosticIds { get; } = ImmutableArray.Create(Constants.Descriptors.X2002_AssertNullShouldNotBeCalledOnValueTypes.Id);
