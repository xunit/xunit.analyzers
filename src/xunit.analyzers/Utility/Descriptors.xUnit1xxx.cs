...
public static partial class Descriptors
{
	...
	public static DiagnosticDescriptor X1037_TheoryArgumentsMustMatchTestMethodParameters_TooFewTypeParameters { get; } =
		Diagnostic(
			"xUnit1037",
	...
	public static DiagnosticDescriptor X1038_TheoryArgumentsMustMatchTestMethodParameters_ExtraTypeParameters { get; } =
		Diagnostic(
			"xUnit1038",
	...
	public static DiagnosticDescriptor X1039_TheoryArgumentsMustMatchTestMethodParameters_IncompatibleTypes { get; } =
		Diagnostic(
			"xUnit1039",
			"The theory argument type is not compatible with the type of the corresponding test method parameter",
			Usage,
			Error,
			"The argument type {0} from {1} is not compatible with the type of the corresponding test method parameter {2}."
		);

	public static DiagnosticDescriptor X1040_TheoryArgumentsMustMatchTestMethodParameters_IncompatibleNullability { get; } =
		Diagnostic(
			"xUnit1040",
			"The theory argument type is nullable, while the type of the corresponding test method parameter is not",
			Usage,
			Warning,
			"The argument type {0} from {1} is nullable, while the type of the corresponding test method parameter {2} is not. Make the theory argument type non-nullable, or make the test method parameter nullable."
		);
	...
	public static DiagnosticDescriptor X1065_MemberDataMethodIsAmbiguous { get; } =
		Diagnostic(
			"xUnit1065",
			"MemberData method is ambiguous",
			Usage,
			Error,
			"Member data '{0}.{1}' is ambiguous. {2}"
		);
	...
	// Placeholder for rule X1074

	// Placeholder for rule X1075

	// Placeholder for rule X1076

	// Placeholder for rule X1077

	// Placeholder for rule X1078

	// Placeholder for rule X1079
}
