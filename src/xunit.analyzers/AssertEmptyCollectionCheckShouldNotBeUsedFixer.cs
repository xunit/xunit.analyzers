...
namespace Xunit.Analyzers
{
    ...
    public class AssertEmptyCollectionCheckShouldNotBeUsedFixer : CodeFixProvider
    {
        ...
        public sealed override ImmutableArray<string> FixableDiagnosticIds { get; } = ImmutableArray.Create(Descriptors.X2011_AssertEmptyCollectionCheckShouldNotBeUsed.Id);
