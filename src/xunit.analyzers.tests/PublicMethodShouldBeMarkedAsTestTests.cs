...
public class TestClass { [Xunit.Fact] public void TestMethod() { } [DerivedCustomTestType] public void CustomTestMethod() {} }";
		...
		{
			var source = "public class TestClass { [" + attribute + "] public void TestMethod() { } public void Method() {} }";
		...
		{
			var source = "public class TestClass { [" + attribute + "] public void TestMethod() { } public void Method(int a) {} }";
		...
		{
			var source = "public class TestClass { [" + attribute + "] public void TestMethod() { } public override void Method() {} }";
