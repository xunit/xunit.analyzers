...
public class X3006_TestCaseMustBeSerializableTests
{
	...
	public async ValueTask V3_only_NonAOT()
	{
		var source = /* lang=c#-test */ """
			...
			""";
		var expected = Verify.Diagnostic("xUnit3006").WithLocation(0).WithArguments("UnserializedTestCase", "Xunit.Sdk.ITestCase", "Xunit.Sdk.IXunitSerializable");
	...
	public async ValueTask V3_only_AOT()
	{
		var source = /* lang=c#-test */ """
			...
			public sealed class UnserializedTestCase : ITestCase { }
			""";
