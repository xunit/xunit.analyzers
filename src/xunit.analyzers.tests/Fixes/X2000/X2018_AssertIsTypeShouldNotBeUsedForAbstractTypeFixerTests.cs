...
using Verify_v2_Pre2_9_3 = CSharpVerifier<X2018_AssertIsTypeShouldNotBeUsedForAbstractTypeFixerTests.Analyzer_v2_Pre2_9_3>;
using Verify_v3_Pre0_6_0 = CSharpVerifier<X2018_AssertIsTypeShouldNotBeUsedForAbstractTypeFixerTests.Analyzer_v3_Pre0_6_0>;

public class X2018_AssertIsTypeShouldNotBeUsedForAbstractTypeFixerTests
{
	[Fact]
	public async ValueTask V2_and_V3_PreOverloads()
	{
	...
	[Fact]
	public async ValueTask V2_and_V3_WithOverloads()
	{
		var before = /* lang=c#-test */ """
			using System;
			using Xunit;
