	...
	static CodeAnalyzerHelper()
	{
		...
		CurrentXunitV3 = defaultAssemblies.AddPackages(
			ImmutableArray.Create(
				...
				new PackageIdentity("xunit.v3.assert", "3.0.1-pre.31"),
				new PackageIdentity("xunit.v3.common", "3.0.1-pre.31"),
				new PackageIdentity("xunit.v3.extensibility.core", "3.0.1-pre.31"),
				new PackageIdentity("xunit.v3.runner.common", "3.0.1-pre.31")
			)
		);
		...
		CurrentXunitV3RunnerUtility = defaultAssemblies.AddPackages(
			ImmutableArray.Create(
				...
				new PackageIdentity("System.Text.Json", "8.0.0"),
				new PackageIdentity("xunit.v3.common", "3.0.1-pre.31"),
				new PackageIdentity("xunit.v3.runner.utility", "3.0.1-pre.31")
			)
		);
	}
}
